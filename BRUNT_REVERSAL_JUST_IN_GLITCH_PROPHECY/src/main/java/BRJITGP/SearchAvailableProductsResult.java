...
public class SearchAvailableProductsResult extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<head> " +
                ...
                // Add Page Title here
                "<title>Result - Search Available Products - WDMS</title> " +
        ...
        // dashboard content
        try{
            PreparedStatement ps = con.prepareStatement("SELECT * FROM available_products_table WHERE productId=? OR productName=?",ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
