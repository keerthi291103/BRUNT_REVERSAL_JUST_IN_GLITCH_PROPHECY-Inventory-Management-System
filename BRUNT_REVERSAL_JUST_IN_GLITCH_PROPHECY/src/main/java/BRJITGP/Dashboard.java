    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<div class=\"container\"> ");
            ...
            out.println("<div class=\"row my-4\"> ");
                ...
                out.println("<div class=\"col-sm\"> " +
                        "<button class=\"btn btn-block action-btn p-3\" onclick=\"location.href='Dashboard/UpdateAvailableProducts'\"> " +
                            "<i class=\"fas fa-search pr-3\"></i> Update Products " +
                        "</button> " +
                    "</div> ");
            out.println("</div> ");
            ...
            out.println("<div class=\"row my-4\"> ");
            	...
            	out.println("<div class=\"col-sm\"> " +
            			"<button class=\"btn btn-block action-btn p-3\" onclick=\"location.href='Dashboard/DeleteAvailableProducts'\"> " +
            				"<i class=\"fas fa-search pr-3\"></i> Delete Products " +
            				"</button> " +
            			"</div> ");
            	
            	out.println("<div class=\"col-sm\"> " +
            			"<button class=\"btn btn-block action-btn p-3\" onclick=\"location.href='Dashboard/ViewDeletedProducts'\"> " +
            				"<i class=\"fas fa-search pr-3\"></i> View Deleted Products " +
            				"</button> " +
            			"</div> ");
