...
@WebServlet(name = "DeleteAvailableProducts", urlPatterns = "/Dashboard/DeleteAvailableProducts")
public class DeleteAvailableProducts extends HttpServlet {
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	Connection con;
        public DeleteAvailableProducts(){
        try{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<head> " +
                ...
                // Add Page Title here
                "<title>Sell Available Products - WDMS</title> " +
        ...
        out.println("<div class=\"container h-100\"> " +
                ...
                // Add Title here
                "<h3 class=\"theme-color\">Delete Available Products</h3> " +
                "</div> " +
                "</div>" );
        ...
        try{
            ...
            if (rs.next()) {
                rs.beforeFirst();
                out.println("<form action=\"DeleteAvailableProductsResult\" method=\"GET\"> " +
                ...
                out.println( "<div class=\"form-group mx-4 mt-4\"> " +
                                    "<button type=\"submit\" class=\"btn login-btn btn-block \">Delete Product</button> " +
                                "</div> " +
                            "</form>");

            } else {
                out.println("<h1 class='text-center'>No Products are their to delete.... </h1>");
                // Back btn - Dashboard
