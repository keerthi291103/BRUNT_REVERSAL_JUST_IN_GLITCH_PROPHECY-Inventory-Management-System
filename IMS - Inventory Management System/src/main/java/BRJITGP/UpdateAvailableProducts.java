...
@WebServlet(name = "UpdateAvailableProducts", urlPatterns = "/Dashboard/UpdateAvailableProducts")

public class UpdateAvailableProducts extends HttpServlet {
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	Connection con;
    public UpdateAvailableProducts(){
        try{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<head> " +
                ...
                // Add Page Title here
                "<title>Update Products - WDMS</title> " +
        ...
        out.println("<div class=\"container h-100\"> " +
                    ...
                    // Add Title here
                    "<h3 class=\"theme-color\">Update Products</h3> " +
                    "</div> " +
                "</div>" );

        // dashboard content
        out.println("<form action=\"UpdateAvailableProductsResult\" method=\"GET\"> " +
                        ...
                        "</div> " +
                        "<div class=\"form-group mx-4 mt-4\"> " +
                            "<button type=\"submit\" class=\"btn login-btn btn-block \">Update Product</button> " +
                        "</div> " +
                    "</form>");
